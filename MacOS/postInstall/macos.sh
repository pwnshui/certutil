...
curl -GLOk "https://raw.githubusercontent.com/pwnshui/certutil/master/MacOS/postInstall/alias"
cat alias >> ~/.bashrc
rm -f alias
...
brew install python mas tldr htop neofetch ffmpeg git wget gcc nmap poppler emacs youtube-dl mpv aria2 sox imagemagick make
python3 install pip
...
sudo defaults write /Library/Preferences/com.apple.loginwindow LoginwindowText "RXN"
